...
public class Controller {
	...
	@PostMapping("/users")
	public ResponseEntity<UserDto> registerCustomer(@RequestBody @Valid UserForm form,
	...
	public ResponseEntity<CompanyDto> registerCompany(@RequestBody @Valid CompanyForm form,
			UriComponentsBuilder uriBuilder) {
	...
	public ResponseEntity<List<CompanyDto>> listAllCompanies(@RequestParam(required = false) String name)
			throws URISyntaxException {
		if (name == null)
